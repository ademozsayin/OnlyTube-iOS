...
// .init(light: ConstellationLight(), dark: ConstellationDark()),
 .init(light: ThirdJerseyLight(), dark: ThirdJerseyDark())
...
public enum ColorSetName: String {
    ...
    case thirdJerseyLight = "Third Jersey - Light"
    case thirdJerseyDark = "Third Jersey - Dark"
}
...
public struct IceCubeDark: ColorSet {
    ...
    public var tintColor: Color = Color.yellow//.init(red: 187 / 255, green: 59 / 255, blue: 226 / 255)
...
public struct IceCubeLight: ColorSet {
    ...
    public var tintColor: Color = Color.navyBlue//.init(red: 187 / 255, green: 59 / 255, blue: 226 / 255)
...
public struct ThirdJerseyLight: ColorSet {
    public var name: ColorSetName = .thirdJerseyLight
    public var scheme: ColorScheme = .light
    public var tintColor: Color = .fenerbahceYellow
    public var primaryBackgroundColor: Color = Color.fenerbahceWhite
    public var secondaryBackgroundColor: Color = .init(hex: 0xFFFFFF)
    public var labelColor: Color = .black
...
public struct ThirdJerseyDark: ColorSet {
    public var name: ColorSetName = .thirdJerseyDark
    public var scheme: ColorScheme = .dark
    public var tintColor: Color = .fenerbahceWhite
    public var primaryBackgroundColor: Color = .fenerbahceDarkBlue//.init(hex: 0x101010)
    public var secondaryBackgroundColor: Color = .init(hex: 0x181818)
    public var labelColor: Color = .init(hex: 0xE2E4E2)
