...
struct PersistenceController {
    ...
    init(inMemory: Bool = false) {
        container = NSPersistentContainer(name: "OnlyJose")
        //        container = NSPersistentCloudKitContainer(name: "Atwy")
        //        try? container.initializeCloudKitSchema(options: [])
        // Add support to group
        let storeUrl = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: "group.agency.fiable.OnlyJose")!.appendingPathComponent("OnlyJose.sqlite")
